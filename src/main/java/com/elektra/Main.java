...
public class Main implements RequestStreamHandler {
    ...
    public void handleRequest(InputStream input, OutputStream output, Context context) throws IOException {
        ...
        // Acceder a httpMethod y path desde requestContext
        // Access to httpMethod and path from requestContext
        Map<String, Object> requestContext = (Map<String, Object>) lambdaEvent.get("requestContext");
            ...
            switch (httpMethod) {
                case "GET":
                    if (path.matches("/employees/\\d+")) {
                        ...
                        // Se envia el top 10 de empleados manejando hilos
                        // Return top 10 employees using threads.
                        response = controller.getTop10EmployeesWithBetterSalaries();
                    }
                    break;
                ...
                case "DELETE":
                    ...
                    } else if (path.equals("/all-employees")) {
